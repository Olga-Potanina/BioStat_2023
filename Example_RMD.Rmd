...
В данных содержится `r nrow (iris)` наблюдений, пропущенные значения отсутствуют. Ниже представлены описательные статистики переменных датасета.

```{r 1, echo = FALSE}
summary (iris, digits=2)
```
# Основные статистики в зависимости от вида 
